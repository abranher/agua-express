<x-layout title="Inventario Productos - Registrar Entrada" react>
                        ...
                        <div class="w-96">
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" @keyup="search" x-model="inputSearch"
                                        ...
                                        <template x-for="result in search">
                                            ...
                                            <a @click="addResultToForm(result)"
                                                ...
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-full w-11 h-11" :src=`${result.image1}`
                                                        :alt="result.name">
                                                </div>
